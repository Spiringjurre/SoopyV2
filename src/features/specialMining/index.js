...
inCrystalHollows(){
if(!this.FeatureManager||!this.FeatureManager.features["dataLoader"])return false;else
...
if(this.tempLoot[Area][treasure])this.tempLoot[Area][treasure]+=amount;else
this.tempLoot[Area][treasure]=amount;
...
if(thing.includes("Green"))treasure="Green_Goblin_Egg";else
if(thing.includes("Red"))treasure="Red_Goblin_Egg";else
if(thing.includes("Yellow"))treasure="Yellow_Goblin_Egg";else
if(thing.includes("Blue"))treasure="Blue_Goblin_Egg";else
treasure="Goblin_Egg";
}
if(treasure){
...
this.registerChat("&r&aYou received &r${thing}&r&a.&r",(e)=>{
delay(100,()=>{
...
if(e.getName().startsWith("\xA7e\xA7lPASSIVE EVENT \xA7b\xA7l2X POWDER \xA7e\xA7lRUNNING FOR \xA7a\xA7l")){
...
if(m>0){
if(!msg)msg+=`&r&aYou received &r&b+${m} &r&aMithril `;else
msg+=`and &r&b+${m} &r&aMithril `;
}
msg+=`Powder&r`;
...
if(name.startsWith("\xA78[\xA77Lv5\xA78] \xA7cWorm")){
...
if(name.startsWith("\xA78[\xA77Lv10\xA78] \xA7cScatha")){
...
if(this.wormEntity&&this.wormEntity.getEntity()["field_70128_L"]){
this.wormEntity=undefined;
}
...
this.wormSpawned=false;
this.wormEntity=undefined;
this.LatestChestTime=undefined
}
